...
class _$UserModelImpl implements _UserModel {
  _$UserModelImpl(
      ...
      @JsonKey(name: 'id_role') this.idRole,
      this.username,
      this.position,
      this.phone,
      this.email);
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, login: $login, createdAt: $createdAt, updatedAt: $updatedAt, idRole: $idRole, username: $username, position: $position, phone: $phone, email: $email)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, login, createdAt, updatedAt,
      idRole, username, position, phone, email);
...
abstract class _UserModel implements UserModel {
  factory _UserModel(
      ...
      @JsonKey(name: 'id_role') final int? idRole,
      final String? username,
      final String? position,
      final String? phone,
